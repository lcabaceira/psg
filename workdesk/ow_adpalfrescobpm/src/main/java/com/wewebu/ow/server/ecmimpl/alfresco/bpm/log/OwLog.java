package com.wewebu.ow.server.ecmimpl.alfresco.bpm.log;
...
/**
 *<p>
 * Alfresco Workdesk Logger for Alfresco BPM (Workflow)<br/>
 * usage:<br/>
...
public class OwLog
{
    ...
    public static Logger getLogger(Class class_p)
    {
        ...
        {
            return Logger.getLogger("owd.adp.alfresco.bpm");
        }
    }
}