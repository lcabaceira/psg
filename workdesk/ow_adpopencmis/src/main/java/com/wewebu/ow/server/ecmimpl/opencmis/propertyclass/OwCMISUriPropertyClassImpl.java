 ...
 *</font></p>
 */
public class OwCMISUriPropertyClassImpl extends OwCMISAbstractNativePropertyClass<String, String, PropertyUriDefinition> implements OwCMISUriPropertyClass
{
    ...
    public OwCMISUriPropertyClassImpl(String className, PropertyUriDefinition propertyDefinition, OwCMISNativeObjectClass<?, ?> objectClass)
    {
        this(className, propertyDefinition, new OwCMISSameTypeConverter<String>(String.class), objectClass);
    }

    public OwCMISUriPropertyClassImpl(String className, PropertyUriDefinition propertyDefinition, OwCMISValueConverter<String, String> converter, OwCMISNativeObjectClass<?, ?> objectClass)
    {
