...
/**
 *<p>
 * SQL AST node : &lt;in predicate&gt; syntax non-terminal as defined by the SQL grammar.<br/>
 *</p>
 *
 *<p><font size="-2">
 ...
 *@since 3.2.0.0
 */
public class OwInPredicate extends OwFormatPredicate
{
     ...
     */
    public OwInPredicate(OwColumnReference columnReference_p, OwInValueList inValueList_p, boolean negated_p, OwPredicateFormat format_p)
    {
