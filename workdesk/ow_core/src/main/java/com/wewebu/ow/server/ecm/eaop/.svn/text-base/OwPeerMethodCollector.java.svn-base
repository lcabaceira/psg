 ...
 *@since 4.0.0.0
 */
public abstract class OwPeerMethodCollector extends OwReflectiveCollector
{
    protected final Method findCollectMethod(Method method_p) throws OwException
    {
        ...
        try
        {
            Method collectMethod = thisClass.getMethod(method_p.getName(), new Class[] { method_p.getReturnType() });
