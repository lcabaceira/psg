...
public class OwExprGreaterOperator extends OwExprComparisonOperator
{
    ...
    public static final OwExprGreaterOperator INSTANCE = new OwExprGreaterOperator();

    /**
     * Constructor
     */
    private OwExprGreaterOperator()
    {
        super(">");
     ...
     * @return a <code>true</code> {@link OwExprBooleanValue} if leftside operand is greater than the right side operand  
