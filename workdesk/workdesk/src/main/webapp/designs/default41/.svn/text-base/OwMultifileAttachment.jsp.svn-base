...
%>
	...
	<body class="owBody default">
        <div style="width: 100%; height: 30%; padding-top: 40px;">
            <p align="center">
                <applet id="multifileattachment" name="Multifile Attachment"
                    ...
                    codebase="<%=m_sServerURL.toString()%>/applets/clientservices" class="OwFileDownloadApplet" MAYSCRIPT>
                    ...
                    <param name="msg_subject" value="<%=m_context.localize("server.plug.owdocsend.subject", "Email with attachment from Alfresco Workdesk")%>"/>
                    <param name="msg_body" value="<%=m_context.localize("server.plug.owdocsend.body", "See attached file...")%>"/>
