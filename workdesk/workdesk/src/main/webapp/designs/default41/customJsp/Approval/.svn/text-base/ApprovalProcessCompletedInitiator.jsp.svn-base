...
<div id="OwDemoForm">
    <div id="OwDemoForm_Header">
        <h1><%=m_View.getContext().localize("jsp.cmg.approval.RequestCompleted", "Request completed")%></h1>
    ...
    <div id="OwDemoForm_MAIN">
		<table class="OwFormTable OwNowrapLabel">
			<tr>
				...
				<td class="DefaultInput"><b><%=m_View.getContext().localize("jsp.cmg.approval.descApproval2", "Confirmation that your request has been approved.")%></b></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="OwPropertyName"><%OwInsertLabelHelper.insertLabel(out, "OW_ATTACHMENTS", m_View.getContext().localize("owlabel.D:bpm:task.bpm:Order", "Order:"), m_View,null);%></td>
			...
			<tr>
				...
				<td class="DefaultInput"><%=m_View.getContext().localize("jsp.cmg.approval.statusApproval", "Request approved by manager and HR")%></td>
			</tr>	
			<tr>
				<td class="OwPropertyName"><%=m_View.getContext().localize("owlabel.D:bpm:task.bpm:percentComplete", "Percent complete:")%></td>
				<td class="DefaultInput">75 %</td>
			</tr>
