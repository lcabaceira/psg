...
<div id="OwDemoForm">
    <div id="OwDemoForm_Header">
        <h1><%=m_View.getContext().localize("jsp.cmg.approval.ApprovedByManager", "Approved by manager")%></h1>
    ...
    <div id="OwDemoForm_MAIN">
		<table class="OwFormTable OwNowrapLabel">
			<tr>
				...
				<td class="DefaultInput"><b><%=m_View.getContext().localize("jsp.cmg.approval.descApproval1", "Request was approved by the manager.")%></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="DefaultInput"><%=m_View.getContext().localize("jsp.cmg.approval.statusApproval1", "Approved by manager")%></td>
			</tr>	
			<tr>
