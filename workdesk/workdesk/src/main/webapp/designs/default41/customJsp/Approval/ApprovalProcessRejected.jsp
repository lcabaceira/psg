...
<div id="OwDemoForm">
    <div id="OwDemoForm_Header">
        <h1><%=m_View.getContext().localize("jsp.cmg.approval.RejectedByManager", "Rejected by manager")%></h1>
    ...
    <div id="OwDemoForm_MAIN">
		<table class="OwFormTable OwNowrapLabel">
			<tr>
				...
				<td class="DefaultInput"><b><%=m_View.getContext().localize("jsp.cmg.approval.descRejected1", "The request has been rejected by the manager.")%></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="DefaultInput"><%=m_View.getContext().localize("jsp.cmg.approval.statusApproval2", "Request rejected by manager")%></td>
			</tr>					
			<tr>
