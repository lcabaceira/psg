...
<div id="OwDemoForm">
    <div id="OwDemoForm_Header">
        <h1><%=m_View.getContext().localize("jsp.cmg.legalapproval.LegalApprovalRejected", "Legal Approval - Your request was rejected by lawyer")%></h1>
    ...
    <div id="OwDemoForm_MAIN">
		<table class="OwFormTable OwNowrapLabel">
			<tr>
				...
				<td class="DefaultInput"><b><%=m_View.getContext().localize("jsp.cmg.legalapproval.descRejected", "The request has been rejected by the lawyer.")%></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="DefaultInput"><%=m_View.getContext().localize("jsp.cmg.legalapproval.statusApproval2", "Request rejected by lawyer")%></td>
			</tr>					
			<tr>
