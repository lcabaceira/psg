...
<div id="OwDemoForm">
    <div id="OwDemoForm_Header">
        <h1><%=m_View.getContext().localize("jsp.cmg.managementapproval.ManagementApproval", "Management Approval - Your request was approved by manager")%></h1>
    ...
    <div id="OwDemoForm_MAIN">
		<table class="OwFormTable OwNowrapLabel">
			<tr>
				...
				<td class="DefaultInput"><b><%=m_View.getContext().localize("jsp.cmg.managementapproval.descApproval", "Request was approved by the manager.")%></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="DefaultInput"><%=m_View.getContext().localize("jsp.cmg.managementapproval.statusApproval1", "Approved by manager")%></td>
			</tr>	
			<tr>
