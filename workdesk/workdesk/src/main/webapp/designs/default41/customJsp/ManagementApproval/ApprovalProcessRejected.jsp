...
<div id="OwDemoForm">
    <div id="OwDemoForm_Header">
        <h1><%=m_View.getContext().localize("jsp.cmg.managementapproval.ManagementApprovalRejected", "Management Approval - Your request was rejected by manager")%></h1>
    ...
    <div id="OwDemoForm_MAIN">
		<table class="OwFormTable OwNowrapLabel">
			<tr>
				...
				<td class="DefaultInput"><b><%=m_View.getContext().localize("jsp.cmg.managementapproval.descRejected", "The request has been rejected by the manager.")%></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="DefaultInput"><%=m_View.getContext().localize("jsp.cmg.managementapproval.statusApproval2", "Request rejected by manager")%></td>
			</tr>					
			<tr>
