	...
	<div id="OwDemoForm_MAIN">
	   <div class="block">
            ...
            <div class="right">
                ...
                %>
                <div class="info">
                    <%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.hrDossierName.info","Please type the HR Dossier name.")%>
                    <%
                    if(((OwObjectPropertyFormularView)m_View).isFieldMandatory("{cmis:folder.cmis:name}")) {
                        %><span style="color: red"><%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.fieldIsMandatory","This field is mandatory.")%></span><%
                    }
                    %>
                </div>
            </div>
        ...
        <div class="block">
            ...
            <div class="right">
                ...
                %>
                <div class="info">
                    <%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.firstName.info","Please type the firstname of employee.")%>
                    <%
                    if(((OwObjectPropertyFormularView)m_View).isFieldMandatory("{F:owd:dossier.owd:firstName}")) {
                        %><span style="color: red"><%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.fieldIsMandatory","This field is mandatory.")%></span><%
                    }
                    %>
                </div>
        ...
        <div class="block">
            ...
            <div class="right">
                ...
                %>
                <div class="info">
                    <%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.lastName.info","Please type the lastname of employee.")%>
                    <%
                    if(((OwObjectPropertyFormularView)m_View).isFieldMandatory("{F:owd:dossier.owd:lastName}")) {
                        %><span style="color: red"><%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.fieldIsMandatory","This field is mandatory.")%></span><%
                    }
                    %>
                </div>
        ...
        <div class="block">
            ...
            <div class="right">
                ...
                %>
                <div class="info">
                    <%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.personnelNumber.info","Please type the personnel number.")%>
                    <%
                    if(((OwObjectPropertyFormularView)m_View).isFieldMandatory("{F:owd:dossier.owd:dossierPersonnelNumber}")) {
                        %><span style="color: red"><%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.fieldIsMandatory","This field is mandatory.")%></span><%
                    }
                    %>
                </div>
