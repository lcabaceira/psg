...
<div id="OwDemoForm">
    ...
    <div id="OwDemoForm_MAIN">
       <div class="block">
            ...
            <div class="right">
                <%
                  OwInsertLabelHelper.insertLabel(out, "SC_Personalnummer", m_View.getContext().localize("jsp.demo.OwCreateRecordForm.personnelNumber","Personnel Number:"), m_View,null);
                  m_View.renderNamedRegion(out,"SC_Personalnummer");
                %>
                ...
                <% 
                   OwInsertLabelHelper.insertLabel(out, "S_date", m_View.getContext().localize("jsp.demo.OwCreateRecordForm.enterdate","Date:"), m_View,null);
                   m_View.renderNamedRegion(out,"S_date"); 
                %>
                <div class="info"><%=m_View.getContext().localize("jsp.demo.OwCreateRecordForm.enterdate.info","Please enter a date.")%></div>
            </div>
        </div>
        <div class="block">
