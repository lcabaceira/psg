    ...
    <div id="OwDemoForm_MAIN">
        <div class="block">
          <div class="left">
			...
			m_View.renderNamedRegion(out,"DateOfBirth"); 
			m_View.renderNamedRegion(out,"ow_err_DateOfBirth");
          ...
          <div class="OwFormTable_Column">
			...
			<table class="OwFormTable">
			     <tr>		
					<td class="OwPropertyName"><%OwInsertLabelHelper.insertLabel(out, "Address", m_View.getContext().localize("jsp.demo.OwDocumentPropertiesForm.address", "Address:"), m_View,null);%></td>
