...
<div id="OwDemoForm">
    <div id="OwDemoForm_Header">
        <h1><%=m_View.getContext().localize("jsp.BPMClaimProcissing.pageref", "Claim Processing")%></h1>
    ...
    <div id="OwDemoForm_MAIN">
		<table class="OwFormTable OwNowrapLabel">
			<tr>
				<td colspan="3" class="DefaultInput" style="color:#FF8400"><b><%=m_View.getContext().localize("owlabel.D:bpm:task.bpm:desc10", "Contact the customer and clarify further steps")%></b><br/><br/></td>
			</tr>		
			<tr>
                <td class="OwRequired">
                    <%
			...
			<tr>
				...
				<td class="OwPropertyName"><%OwInsertLabelHelper.insertLabel(out, "ow_ro_{D:bpm:task.bpm:priority}", m_View.getContext().localize("owlabel.D:bpm:task.bpm:priority", "Priority"), m_View,null);%>:</td>
				<td class="DefaultInput">
                    <div class="OwPropertyControl">
			...
			<tr>
				...
				<td class="OwPropertyName"><%OwInsertLabelHelper.insertLabel(out, "{P:owdbpm:nextStepAspect.owdbpm:nextStep}", m_View.getContext().localize("owlabel.P:owdbpm:nextStepAspect.owdbpm:nextStep", "Solution or Next Steps"), m_View,null);%>:</td>
				<td class="DefaultInput">
                    <div class="OwPropertyControl">
