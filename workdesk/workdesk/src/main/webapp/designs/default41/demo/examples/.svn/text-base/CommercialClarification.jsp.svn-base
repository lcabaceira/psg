...
<div id="OwDemoForm">
    <div id="OwDemoForm_Header">
        <h1><%=m_View.getContext().localize("jsp.BPMCommercialClarification.pageref", "Commercial Clarification")%></h1>
    ...
    <!-- Main area -->
  	<div id="OwDemoForm_MAIN">
		<table class="OwFormTable OwNowrapLabel">
			<tr>
				<td colspan="3" class="DefaultInput" style="color:#FF8400"><b><%=m_View.getContext().localize("owlabel.D:bpm:task.bpm:desc15", "&#8658; Check the agreed next steps from Customer Service and get in contact with customer")%></b><br/><br/></td>
			</tr>
			<tr>
                <td class="OwRequired">
                    <%
			...
			<tr>
				...
				<td class="OwPropertyName"><%OwInsertLabelHelper.insertLabel(out, "ow_ro_{P:owdbpm:nextStepAspect.owdbpm:nextStep}", m_View.getContext().localize("owlabel.P:owdbpm:nextStepAspect.owdbpm:nextStep1", "Agreed Steps by Customer Service"), m_View,null);%>:</td>
				<td class="DefaultInput">
                    <div class="OwPropertyControl">
